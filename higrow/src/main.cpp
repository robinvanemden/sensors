...
uint16_t readSoil()
{
    ...
    return map(soil, 1600, 3430, 100, 0);
}
...
CAYENNE_OUT(SOIL_VIRTUAL_CHANNEL)
{
    ...
    Cayenne.virtualWrite(SOIL_VIRTUAL_CHANNEL, (int)soil, TYPE_RELATIVE_HUMIDITY, UNIT_PERCENT);
}

CAYENNE_OUT(SALT_VIRTUAL_CHANNEL)
{
    uint32_t salt = readSalt();
    Cayenne.virtualWrite(SALT_VIRTUAL_CHANNEL, (int)salt, TYPE_RELATIVE_HUMIDITY, UNIT_PERCENT);
}
